本文翻译至 [project-guidelines](https://github.com/wearehive/project-guidelines)

# 项目指南 &middot; [![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com)
> 当开发一个新项目的时候就像是在绿茵场上滚动, maintaining it is a potential dark twisted nightmare for someone else.
